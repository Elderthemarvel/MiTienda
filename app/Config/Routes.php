...
$routes->get('/edit/(:num)', 'Home::productos edit/$1');
$routes->post('/update/(:num)', 'Home::productos_update/$1');
$routes->get('/confirm-delete/(:num)', 'Home::productos_confirmDelete/$1');
$routes->post('/delete/(:num)', 'Home::productos_delete/$1');
