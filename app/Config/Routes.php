...
$routes->get('clientes/edit/(:num)', 'ProductosController::productos_edit/$1');
$routes->post('/update/(:num)', 'ProductosController::productos_update/$1');
$routes->get('/confirm-delete/(:num)', 'ProductosController::productos_confirmDelete/$1');
$routes->post('/delete/(:num)', 'ProductosController::productos_delete/$1');
